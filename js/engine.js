...
class Engine {
    ...
    start ( ) {
        ...
        this.composer = new Composer(song, 'noteskins/EXCEED2-OLD/HD/' ,2, keyBoardLag);
        // this.composer = new Composer(song, 'noteskins/NX/HD/' ,4.5, keyBoardLag);
        ...
        let playerCourse = this.composer.run(0) ;
